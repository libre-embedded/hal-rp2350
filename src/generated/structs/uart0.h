...
#pragma once
#ifndef RP2350_STRUCTS_UART0_H
#define RP2350_STRUCTS_UART0_H
...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 39;     /*!< uart0's identifier. */
...
static_assert(ifgen_struct<uart0>);

static volatile uart0 *const UART0 = reinterpret_cast<uart0 *>(0x40070000);

static volatile uart0 *const UART1 = reinterpret_cast<uart0 *>(0x40078000);
