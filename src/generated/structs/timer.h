...
#pragma once
#ifndef RP2350_STRUCTS_TIMER_H
#define RP2350_STRUCTS_TIMER_H
...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 43;   /*!< timer's identifier. */
...
static_assert(ifgen_struct<timer>);

static volatile timer *const TIMER0 = reinterpret_cast<timer *>(0x400b0000);

static volatile timer *const TIMER1 = reinterpret_cast<timer *>(0x400b8000);

template <uint8_t instance>
inline volatile timer *timer_instance(void)
    requires(instance == 0)
{
    return TIMER0;
}
