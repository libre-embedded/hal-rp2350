...
#pragma once
#ifndef RP2350_STRUCTS_PADS_QSPI_H
#define RP2350_STRUCTS_PADS_QSPI_H
...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 22;   /*!< pads_qspi's identifier. */
    ...
    /**
     * Get GPIO_QSPI_SCLK's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline bool get_GPIO_QSPI_SCLK_ISO() volatile
    {
        return GPIO_QSPI_SCLK & (1u << 8u);
    }

    /**
     * Set GPIO_QSPI_SCLK's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void set_GPIO_QSPI_SCLK_ISO() volatile
    {
        GPIO_QSPI_SCLK |= 1u << 8u;
    }

    /**
     * Clear GPIO_QSPI_SCLK's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void clear_GPIO_QSPI_SCLK_ISO() volatile
    {
        GPIO_QSPI_SCLK &= ~(1u << 8u);
    }

    /**
     * Toggle GPIO_QSPI_SCLK's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void toggle_GPIO_QSPI_SCLK_ISO() volatile
    {
        GPIO_QSPI_SCLK ^= 1u << 8u;
    }
    ...
    /**
     * Get GPIO_QSPI_SD0's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline bool get_GPIO_QSPI_SD0_ISO() volatile
    {
        return GPIO_QSPI_SD0 & (1u << 8u);
    }

    /**
     * Set GPIO_QSPI_SD0's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void set_GPIO_QSPI_SD0_ISO() volatile
    {
        GPIO_QSPI_SD0 |= 1u << 8u;
    }

    /**
     * Clear GPIO_QSPI_SD0's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void clear_GPIO_QSPI_SD0_ISO() volatile
    {
        GPIO_QSPI_SD0 &= ~(1u << 8u);
    }

    /**
     * Toggle GPIO_QSPI_SD0's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void toggle_GPIO_QSPI_SD0_ISO() volatile
    {
        GPIO_QSPI_SD0 ^= 1u << 8u;
    }
    ...
    /**
     * Get GPIO_QSPI_SD1's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline bool get_GPIO_QSPI_SD1_ISO() volatile
    {
        return GPIO_QSPI_SD1 & (1u << 8u);
    }

    /**
     * Set GPIO_QSPI_SD1's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void set_GPIO_QSPI_SD1_ISO() volatile
    {
        GPIO_QSPI_SD1 |= 1u << 8u;
    }

    /**
     * Clear GPIO_QSPI_SD1's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void clear_GPIO_QSPI_SD1_ISO() volatile
    {
        GPIO_QSPI_SD1 &= ~(1u << 8u);
    }

    /**
     * Toggle GPIO_QSPI_SD1's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void toggle_GPIO_QSPI_SD1_ISO() volatile
    {
        GPIO_QSPI_SD1 ^= 1u << 8u;
    }
    ...
    /**
     * Get GPIO_QSPI_SD2's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline bool get_GPIO_QSPI_SD2_ISO() volatile
    {
        return GPIO_QSPI_SD2 & (1u << 8u);
    }

    /**
     * Set GPIO_QSPI_SD2's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void set_GPIO_QSPI_SD2_ISO() volatile
    {
        GPIO_QSPI_SD2 |= 1u << 8u;
    }

    /**
     * Clear GPIO_QSPI_SD2's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void clear_GPIO_QSPI_SD2_ISO() volatile
    {
        GPIO_QSPI_SD2 &= ~(1u << 8u);
    }

    /**
     * Toggle GPIO_QSPI_SD2's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void toggle_GPIO_QSPI_SD2_ISO() volatile
    {
        GPIO_QSPI_SD2 ^= 1u << 8u;
    }
    ...
    /**
     * Get GPIO_QSPI_SD3's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline bool get_GPIO_QSPI_SD3_ISO() volatile
    {
        return GPIO_QSPI_SD3 & (1u << 8u);
    }

    /**
     * Set GPIO_QSPI_SD3's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void set_GPIO_QSPI_SD3_ISO() volatile
    {
        GPIO_QSPI_SD3 |= 1u << 8u;
    }

    /**
     * Clear GPIO_QSPI_SD3's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void clear_GPIO_QSPI_SD3_ISO() volatile
    {
        GPIO_QSPI_SD3 &= ~(1u << 8u);
    }

    /**
     * Toggle GPIO_QSPI_SD3's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void toggle_GPIO_QSPI_SD3_ISO() volatile
    {
        GPIO_QSPI_SD3 ^= 1u << 8u;
    }
    ...
    /**
     * Get GPIO_QSPI_SS's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline bool get_GPIO_QSPI_SS_ISO() volatile
    {
        return GPIO_QSPI_SS & (1u << 8u);
    }

    /**
     * Set GPIO_QSPI_SS's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void set_GPIO_QSPI_SS_ISO() volatile
    {
        GPIO_QSPI_SS |= 1u << 8u;
    }

    /**
     * Clear GPIO_QSPI_SS's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void clear_GPIO_QSPI_SS_ISO() volatile
    {
        GPIO_QSPI_SS &= ~(1u << 8u);
    }

    /**
     * Toggle GPIO_QSPI_SS's ISO bit.
     *
     * Pad isolation control. Remove this once the pad is configured by
     * software.
     */
    inline void toggle_GPIO_QSPI_SS_ISO() volatile
    {
        GPIO_QSPI_SS ^= 1u << 8u;
    }
...
static_assert(ifgen_struct<pads_qspi>);

static volatile pads_qspi *const PADS_QSPI =
    reinterpret_cast<pads_qspi *>(0x40040000);
