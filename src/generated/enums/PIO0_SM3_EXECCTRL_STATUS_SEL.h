...
#pragma once
#ifndef RP2350_ENUMS_PIO0_SM3_EXECCTRL_STATUS_SEL_H
#define RP2350_ENUMS_PIO0_SM3_EXECCTRL_STATUS_SEL_H
...
inline const char *to_string(PIO0_SM3_EXECCTRL_STATUS_SEL instance)
{
    ...
    case PIO0_SM3_EXECCTRL_STATUS_SEL::RXLEVEL:
        result = "RXLEVEL";
        break;
    case PIO0_SM3_EXECCTRL_STATUS_SEL::IRQ:
        result = "IRQ";
        break;
    }
...
inline std::ostream &operator<<(std::ostream &stream,
                                PIO0_SM3_EXECCTRL_STATUS_SEL instance)
{
...
inline bool from_string(const char *data, PIO0_SM3_EXECCTRL_STATUS_SEL &output)
{
    ...
    {
        output = PIO0_SM3_EXECCTRL_STATUS_SEL::IRQ;
    }
