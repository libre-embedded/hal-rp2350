...
#pragma once
#ifndef RP2350_ENUMS_IO_BANK0_GPIO3_CTRL_FUNCSEL_H
#define RP2350_ENUMS_IO_BANK0_GPIO3_CTRL_FUNCSEL_H
...
inline const char *to_string(IO_BANK0_GPIO3_CTRL_FUNCSEL instance)
{
    ...
    case IO_BANK0_GPIO3_CTRL_FUNCSEL::pwm_b_1:
        result = "pwm_b_1";
        break;
    case IO_BANK0_GPIO3_CTRL_FUNCSEL::siob_proc_3:
        result = "siob_proc_3";
        break;
    ...
    case IO_BANK0_GPIO3_CTRL_FUNCSEL::pio1_3:
        result = "pio1_3";
        break;
    case IO_BANK0_GPIO3_CTRL_FUNCSEL::pio2_3:
        result = "pio2_3";
        break;
    case IO_BANK0_GPIO3_CTRL_FUNCSEL::coresight_tracedata_1:
        result = "coresight_tracedata_1";
        break;
    case IO_BANK0_GPIO3_CTRL_FUNCSEL::usb_muxing_overcurr_detect:
        result = "usb_muxing_overcurr_detect";
        break;
    case IO_BANK0_GPIO3_CTRL_FUNCSEL::uart0_rx:
        result = "uart0_rx";
        break;
...
inline std::ostream &operator<<(std::ostream &stream,
                                IO_BANK0_GPIO3_CTRL_FUNCSEL instance)
{
...
inline bool from_string(const char *data, IO_BANK0_GPIO3_CTRL_FUNCSEL &output)
{
    ...
    {
        output = IO_BANK0_GPIO3_CTRL_FUNCSEL::siob_proc_3;
    }
    ...
    {
        output = IO_BANK0_GPIO3_CTRL_FUNCSEL::pio2_3;
    }
    else if ((result = !strncmp(data, "coresight_tracedata_1", 21)))
    {
        output = IO_BANK0_GPIO3_CTRL_FUNCSEL::coresight_tracedata_1;
    }
    ...
    {
        output = IO_BANK0_GPIO3_CTRL_FUNCSEL::uart0_rx;
    }
