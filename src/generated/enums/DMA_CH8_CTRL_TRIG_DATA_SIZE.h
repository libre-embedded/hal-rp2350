...
#pragma once
#ifndef RP2350_ENUMS_DMA_CH8_CTRL_TRIG_DATA_SIZE_H
#define RP2350_ENUMS_DMA_CH8_CTRL_TRIG_DATA_SIZE_H
...
inline const char *to_string(DMA_CH8_CTRL_TRIG_DATA_SIZE instance)
{
    ...
    switch (instance)
    {
    case DMA_CH8_CTRL_TRIG_DATA_SIZE::BYTE:
        result = "BYTE";
        break;
    case DMA_CH8_CTRL_TRIG_DATA_SIZE::HALFWORD:
        result = "HALFWORD";
        break;
    case DMA_CH8_CTRL_TRIG_DATA_SIZE::WORD:
        result = "WORD";
        break;
    }
...
inline std::ostream &operator<<(std::ostream &stream,
                                DMA_CH8_CTRL_TRIG_DATA_SIZE instance)
{
...
inline bool from_string(const char *data, DMA_CH8_CTRL_TRIG_DATA_SIZE &output)
{
    ...
    {
        output = DMA_CH8_CTRL_TRIG_DATA_SIZE::BYTE;
    }
    else if ((result = !strncmp(data, "HALFWORD", 8)))
    {
        output = DMA_CH8_CTRL_TRIG_DATA_SIZE::HALFWORD;
    }
    else if ((result = !strncmp(data, "WORD", 4)))
    {
        output = DMA_CH8_CTRL_TRIG_DATA_SIZE::WORD;
    }
