...
#pragma once
#ifndef RP2350_ENUMS_CLOCKS_CLK_REF_CTRL_AUXSRC_H
#define RP2350_ENUMS_CLOCKS_CLK_REF_CTRL_AUXSRC_H
...
inline const char *to_string(CLOCKS_CLK_REF_CTRL_AUXSRC instance)
{
    ...
    case CLOCKS_CLK_REF_CTRL_AUXSRC::gpin1:
        result = "gpin1";
        break;
    case CLOCKS_CLK_REF_CTRL_AUXSRC::pll_usb_primary_ref_opcg:
        result = "pll_usb_primary_ref_opcg";
        break;
    }
...
inline std::ostream &operator<<(std::ostream &stream,
                                CLOCKS_CLK_REF_CTRL_AUXSRC instance)
{
...
inline bool from_string(const char *data, CLOCKS_CLK_REF_CTRL_AUXSRC &output)
{
    ...
    else if ((result = !strncmp(data, "pll_usb_primary_ref_opcg", 24)))
    {
        output = CLOCKS_CLK_REF_CTRL_AUXSRC::pll_usb_primary_ref_opcg;
    }
