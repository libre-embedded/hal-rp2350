...
#pragma once
#ifndef RP2350_ENUMS_IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL_H
#define RP2350_ENUMS_IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL_H
...
inline const char *to_string(IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL instance)
{
    ...
    case IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL::xip_sd0:
        result = "xip_sd0";
        break;
    case IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL::uart0_tx:
        result = "uart0_tx";
        break;
    case IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL::i2c0_sda:
        result = "i2c0_sda";
        break;
    case IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL::siob_proc_60:
        result = "siob_proc_60";
        break;
...
inline std::ostream &operator<<(std::ostream &stream,
                                IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL instance)
{
                        ...
                        IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL &output)
{
    ...
    {
        output = IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL::uart0_tx;
    }
    else if ((result = !strncmp(data, "i2c0_sda", 8)))
    {
        output = IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL::i2c0_sda;
    }
    else if ((result = !strncmp(data, "siob_proc_60", 12)))
    {
        output = IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL::siob_proc_60;
    }
