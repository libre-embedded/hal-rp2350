...
#pragma once
#ifndef RP2350_ENUMS_IO_BANK0_GPIO4_CTRL_FUNCSEL_H
#define RP2350_ENUMS_IO_BANK0_GPIO4_CTRL_FUNCSEL_H
...
inline const char *to_string(IO_BANK0_GPIO4_CTRL_FUNCSEL instance)
{
    ...
    case IO_BANK0_GPIO4_CTRL_FUNCSEL::pwm_a_2:
        result = "pwm_a_2";
        break;
    case IO_BANK0_GPIO4_CTRL_FUNCSEL::siob_proc_4:
        result = "siob_proc_4";
        break;
    ...
    case IO_BANK0_GPIO4_CTRL_FUNCSEL::pio1_4:
        result = "pio1_4";
        break;
    case IO_BANK0_GPIO4_CTRL_FUNCSEL::pio2_4:
        result = "pio2_4";
        break;
    case IO_BANK0_GPIO4_CTRL_FUNCSEL::coresight_tracedata_2:
...
inline std::ostream &operator<<(std::ostream &stream,
                                IO_BANK0_GPIO4_CTRL_FUNCSEL instance)
{
...
inline bool from_string(const char *data, IO_BANK0_GPIO4_CTRL_FUNCSEL &output)
{
    ...
    {
        output = IO_BANK0_GPIO4_CTRL_FUNCSEL::siob_proc_4;
    }
    ...
    {
        output = IO_BANK0_GPIO4_CTRL_FUNCSEL::pio2_4;
    }
    else if ((result = !strncmp(data, "coresight_tracedata_2", 21)))
    {
        output = IO_BANK0_GPIO4_CTRL_FUNCSEL::coresight_tracedata_2;
    }
