...
#pragma once
#ifndef RP2350_ENUMS_CLOCKS_CLK_GPOUT2_CTRL_AUXSRC_H
#define RP2350_ENUMS_CLOCKS_CLK_GPOUT2_CTRL_AUXSRC_H
...
inline const char *to_string(CLOCKS_CLK_GPOUT2_CTRL_AUXSRC instance)
{
    ...
    case CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::clksrc_pll_usb:
        ...
        break;
    case CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::clksrc_pll_usb_primary_ref_opcg:
    ...
    case CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::xosc_clksrc:
        result = "xosc_clksrc";
        break;
    case CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::lposc_clksrc:
        result = "lposc_clksrc";
        break;
    ...
    case CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::clk_ref:
        result = "clk_ref";
        break;
    case CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::clk_peri:
        result = "clk_peri";
        break;
    case CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::clk_hstx:
        result = "clk_hstx";
        break;
    case CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::otp_clk2fc:
        result = "otp_clk2fc";
        break;
    }
...
inline std::ostream &operator<<(std::ostream &stream,
                                CLOCKS_CLK_GPOUT2_CTRL_AUXSRC instance)
{
                        ...
                        CLOCKS_CLK_GPOUT2_CTRL_AUXSRC &output)
{
    ...
    {
        output =
            CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::clksrc_pll_usb_primary_ref_opcg;
    }
    ...
    {
        output = CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::lposc_clksrc;
    }
    ...
    {
        output = CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::clk_peri;
    }
    else if ((result = !strncmp(data, "clk_hstx", 8)))
    {
        output = CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::clk_hstx;
    }
    else if ((result = !strncmp(data, "otp_clk2fc", 10)))
    {
        output = CLOCKS_CLK_GPOUT2_CTRL_AUXSRC::otp_clk2fc;
    }
