...
#pragma once
#ifndef RP2350_ENUMS_PADS_BANK0_GPIO1_DRIVE_H
#define RP2350_ENUMS_PADS_BANK0_GPIO1_DRIVE_H
...
inline const char *to_string(PADS_BANK0_GPIO1_DRIVE instance)
{
    ...
    switch (instance)
    {
    case PADS_BANK0_GPIO1_DRIVE::_2mA:
        result = "_2mA";
        break;
    case PADS_BANK0_GPIO1_DRIVE::_4mA:
        result = "_4mA";
        break;
    case PADS_BANK0_GPIO1_DRIVE::_8mA:
        result = "_8mA";
        break;
    case PADS_BANK0_GPIO1_DRIVE::_12mA:
        result = "_12mA";
        break;
    }
...
inline std::ostream &operator<<(std::ostream &stream,
                                PADS_BANK0_GPIO1_DRIVE instance)
{
...
inline bool from_string(const char *data, PADS_BANK0_GPIO1_DRIVE &output)
{
    ...
    {
        output = PADS_BANK0_GPIO1_DRIVE::_2mA;
    }
    else if ((result = !strncmp(data, "_4mA", 4)))
    {
        output = PADS_BANK0_GPIO1_DRIVE::_4mA;
    }
    else if ((result = !strncmp(data, "_8mA", 4)))
    {
        output = PADS_BANK0_GPIO1_DRIVE::_8mA;
    }
    else if ((result = !strncmp(data, "_12mA", 5)))
    {
        output = PADS_BANK0_GPIO1_DRIVE::_12mA;
    }
