...
#pragma once
#ifndef RP2350_ENUMS_CLOCKS_FC0_SRC_FC0_SRC_H
#define RP2350_ENUMS_CLOCKS_FC0_SRC_FC0_SRC_H
...
inline const char *to_string(CLOCKS_FC0_SRC_FC0_SRC instance)
{
    ...
    case CLOCKS_FC0_SRC_FC0_SRC::clk_adc:
        result = "clk_adc";
        break;
    case CLOCKS_FC0_SRC_FC0_SRC::clk_hstx:
        result = "clk_hstx";
        break;
    case CLOCKS_FC0_SRC_FC0_SRC::lposc_clksrc:
        result = "lposc_clksrc";
        break;
    case CLOCKS_FC0_SRC_FC0_SRC::otp_clk2fc:
        result = "otp_clk2fc";
        break;
    case CLOCKS_FC0_SRC_FC0_SRC::pll_usb_clksrc_primary_dft:
        result = "pll_usb_clksrc_primary_dft";
        break;
    }
...
inline bool from_string(const char *data, CLOCKS_FC0_SRC_FC0_SRC &output)
{
    ...
    {
        output = CLOCKS_FC0_SRC_FC0_SRC::clk_hstx;
    }
    else if ((result = !strncmp(data, "lposc_clksrc", 12)))
    {
        output = CLOCKS_FC0_SRC_FC0_SRC::lposc_clksrc;
    }
    else if ((result = !strncmp(data, "otp_clk2fc", 10)))
    {
        output = CLOCKS_FC0_SRC_FC0_SRC::otp_clk2fc;
    }
    else if ((result = !strncmp(data, "pll_usb_clksrc_primary_dft", 26)))
    {
        output = CLOCKS_FC0_SRC_FC0_SRC::pll_usb_clksrc_primary_dft;
    }
