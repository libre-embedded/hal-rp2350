...
#pragma once
#ifndef RP2350_ENUMS_IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL_H
#define RP2350_ENUMS_IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL_H
...
inline const char *to_string(IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL instance)
{
    ...
    case IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL::xip_sd1:
        result = "xip_sd1";
        break;
    case IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL::uart0_rx:
        result = "uart0_rx";
        break;
    case IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL::i2c0_scl:
        result = "i2c0_scl";
        break;
    case IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL::siob_proc_61:
        result = "siob_proc_61";
        break;
...
inline std::ostream &operator<<(std::ostream &stream,
                                IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL instance)
{
                        ...
                        IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL &output)
{
    ...
    {
        output = IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL::uart0_rx;
    }
    else if ((result = !strncmp(data, "i2c0_scl", 8)))
    {
        output = IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL::i2c0_scl;
    }
    else if ((result = !strncmp(data, "siob_proc_61", 12)))
    {
        output = IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL::siob_proc_61;
    }
